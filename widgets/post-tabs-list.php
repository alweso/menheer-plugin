...
class PostTabsList extends Widget_Base {
    ...
    public function __construct( $data = array(), $args = null ) {
      ...
      wp_register_style( 'post-tabs-list', plugins_url( '/assets/css/post-tabs-list.css', ELEMENTOR_AWESOMESAUCE ), array(), '1.0.0' );
    }
...
public function get_style_depends() {
  return array( 'general', 'post-tabs-list' );
}
...
protected function _register_controls() {
  ...
  $this->add_control(
    ...
    [
      ...
      'default' => __( 'Post tabs list', 'menheer-plugin' ),
    ]
  );
